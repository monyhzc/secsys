  ...
  <el-main>
    ...
    <el-table :height="tableHeight" :data="tableList" border stripe>
      ...
      <el-table-column align="center" width="280" label="操作">
        <template slot-scope="scope">
          <el-button v-if="hasPerm('sys:myRepair:edit')" type="primary" icon="el-icon-edit" size="small"
            @click="editBtn(scope.row)">编辑</el-button>
          <el-button v-if="hasPerm('sys:myRepair:delete')" type="danger" icon="el-icon-delete" size="small"
